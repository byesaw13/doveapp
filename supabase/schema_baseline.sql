...
CREATE OR REPLACE FUNCTION "public"."calculate_next_maintenance_date"("last_date" "date", "interval_days" integer) RETURNS "date"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."calculate_next_maintenance_date"("last_date" "date", "interval_days" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."calculate_time_entry_totals"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."calculate_time_entry_totals"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."execute_job_workflow"("job_uuid" "uuid", "workflow_uuid" "uuid") RETURNS "jsonb"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  job_record RECORD;
...
ALTER FUNCTION "public"."execute_job_workflow"("job_uuid" "uuid", "workflow_uuid" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_current_technician_rate"("tech_name" "text", "check_date" "date" DEFAULT CURRENT_DATE) RETURNS numeric
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."get_current_technician_rate"("tech_name" "text", "check_date" "date") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_tool_recognition_stats"("days_back" integer DEFAULT 30) RETURNS TABLE("total_analyses" bigint, "successful_analyses" bigint, "average_matches" numeric, "high_confidence_rate" numeric, "verification_rate" numeric)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_tool_recognition_stats"("days_back" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."process_tool_recognition_matches"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."process_tool_recognition_matches"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."record_material_transaction"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."record_material_transaction"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."schedule_next_maintenance"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."schedule_next_maintenance"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."set_estimate_number"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_estimate_number"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."tech_update_job_status"("p_job_id" "uuid", "p_new_status" "text") RETURNS "void"
...
ALTER FUNCTION "public"."tech_update_job_status"("p_job_id" "uuid", "p_new_status" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trigger_job_workflows"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  workflow_record RECORD;
...
ALTER FUNCTION "public"."trigger_job_workflows"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_ai_estimate_settings_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_ai_estimate_settings_updated_at"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_employee_profile_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_employee_profile_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_estimates_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
CREATE OR REPLACE FUNCTION "public"."update_job_payment_status"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
...
ALTER FUNCTION "public"."update_job_payment_status"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_job_payment_status_on_delete"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
declare
  job_total decimal(10,2);
...
ALTER FUNCTION "public"."update_job_payment_status_on_delete"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_job_templates_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_job_templates_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_job_workflows_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_job_workflows_updated_at"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_material_stock_on_job_usage"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_material_stock_on_job_usage"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_security_settings_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_security_settings_updated_at"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_tool_status_on_assignment"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_tool_status_on_assignment"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."user_is_account_admin"("account_uuid" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
  RETURN EXISTS (
...
ALTER FUNCTION "public"."user_is_account_admin"("account_uuid" "uuid") OWNER TO "postgres";
...
ALTER TABLE "public"."account_memberships" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."accounts" (
    ...
    "custom_domain" "text",
    "logo_url" "text",
    "brand_primary_color" "text" DEFAULT '#0073ea'::"text",
...
CREATE TABLE IF NOT EXISTS "public"."ai_estimate_settings" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid",
...
ALTER TABLE "public"."ai_estimate_settings" OWNER TO "postgres";
...
ALTER TABLE "public"."automation_history" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."customer_communications" (
    ...
    "job_id" "uuid",
    "invoice_id" "uuid",
    CONSTRAINT "customer_communications_communication_type_check" CHECK ((("communication_type")::"text" = ANY ((ARRAY['call'::character varying, 'email'::character varying, 'note'::character varying, 'meeting'::character varying, 'sms'::character varying, 'in_person'::character varying, 'other'::character varying])::"text"[]))),
...
ALTER TABLE "public"."email_insights" OWNER TO "postgres";
...
ALTER TABLE "public"."email_lead_details" OWNER TO "postgres";
...
ALTER TABLE "public"."emails_raw" OWNER TO "postgres";
...
ALTER TABLE "public"."job_line_items" OWNER TO "postgres";
...
ALTER VIEW "public"."job_time_summary" OWNER TO "postgres";
...
ALTER TABLE "public"."job_tools" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."job_workflow_executions" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "job_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."job_workflow_executions" OWNER TO "postgres";
...
ALTER TABLE "public"."job_workflows" OWNER TO "postgres";
...
ALTER TABLE "public"."material_transactions" OWNER TO "postgres";
...
ALTER VIEW "public"."technician_productivity" OWNER TO "postgres";
...
ALTER TABLE "public"."technician_rates" OWNER TO "postgres";
...
ALTER TABLE "public"."time_approvals" OWNER TO "postgres";
...
ALTER TABLE "public"."time_breaks" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."time_tracking_summary" AS
 SELECT "te"."id",
    "te"."account_id",
    "te"."technician_name",
    "te"."job_id",
...
ALTER VIEW "public"."time_tracking_summary" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."tool_availability" AS
 SELECT "id",
    "name",
    "category",
    "serial_number",
...
ALTER VIEW "public"."tool_availability" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tool_inventory_counts" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
...
ALTER TABLE "public"."tool_inventory_counts" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tool_recognition_matches" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "recognition_result_id" "uuid",
    "material_id" "uuid",
...
ALTER TABLE "public"."tool_recognition_matches" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."tool_recognition_results" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "image_url" "text" NOT NULL,
    "image_hash" "text",
...
ALTER TABLE "public"."tool_recognition_results" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."tool_recognition_summary" AS
...
ALTER VIEW "public"."tool_recognition_summary" OWNER TO "postgres";
...
CREATE INDEX "idx_gmail_connections_active" ON "public"."gmail_connections" USING "btree" ("is_active");



CREATE INDEX "idx_gmail_connections_email" ON "public"."gmail_connections" USING "btree" ("email_address");
...
CREATE OR REPLACE TRIGGER "business_settings_updated_at" BEFORE UPDATE ON "public"."business_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_business_settings_updated_at"();
...
CREATE OR REPLACE TRIGGER "employee_profiles_updated_at" BEFORE UPDATE ON "public"."employee_profiles" FOR EACH ROW EXECUTE FUNCTION "public"."update_employee_profile_updated_at"();



CREATE OR REPLACE TRIGGER "estimate_templates_updated_at" BEFORE UPDATE ON "public"."estimate_templates" FOR EACH ROW EXECUTE FUNCTION "public"."update_estimates_updated_at"();



CREATE OR REPLACE TRIGGER "estimates_updated_at" BEFORE UPDATE ON "public"."estimates" FOR EACH ROW EXECUTE FUNCTION "public"."update_estimates_updated_at"();
...
CREATE OR REPLACE TRIGGER "job_status_change_workflows" AFTER UPDATE ON "public"."jobs" FOR EACH ROW EXECUTE FUNCTION "public"."trigger_job_workflows"();



CREATE OR REPLACE TRIGGER "job_templates_updated_at" BEFORE UPDATE ON "public"."job_templates" FOR EACH ROW EXECUTE FUNCTION "public"."update_job_templates_updated_at"();



CREATE OR REPLACE TRIGGER "job_workflows_updated_at" BEFORE UPDATE ON "public"."job_workflows" FOR EACH ROW EXECUTE FUNCTION "public"."update_job_workflows_updated_at"();



CREATE OR REPLACE TRIGGER "leads_updated_at" BEFORE UPDATE ON "public"."leads" FOR EACH ROW EXECUTE FUNCTION "public"."update_leads_updated_at"();



CREATE OR REPLACE TRIGGER "set_estimate_number_trigger" BEFORE INSERT ON "public"."estimates" FOR EACH ROW EXECUTE FUNCTION "public"."set_estimate_number"();
...
CREATE OR REPLACE TRIGGER "trigger_calculate_break_duration" BEFORE INSERT OR UPDATE ON "public"."time_breaks" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_break_duration"();



CREATE OR REPLACE TRIGGER "trigger_calculate_time_entry_totals" BEFORE INSERT OR UPDATE ON "public"."time_entries" FOR EACH ROW EXECUTE FUNCTION "public"."calculate_time_entry_totals"();



CREATE OR REPLACE TRIGGER "trigger_process_tool_recognition_matches" AFTER INSERT ON "public"."tool_recognition_results" FOR EACH ROW WHEN (("new"."processing_status" = 'completed'::"text")) EXECUTE FUNCTION "public"."process_tool_recognition_matches"();



CREATE OR REPLACE TRIGGER "trigger_schedule_next_maintenance" AFTER UPDATE ON "public"."tool_maintenance" FOR EACH ROW EXECUTE FUNCTION "public"."schedule_next_maintenance"();



CREATE OR REPLACE TRIGGER "trigger_update_ai_estimate_settings_updated_at" BEFORE UPDATE ON "public"."ai_estimate_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_ai_estimate_settings_updated_at"();



CREATE OR REPLACE TRIGGER "trigger_update_material_stock_on_job_usage" AFTER INSERT ON "public"."job_materials" FOR EACH ROW EXECUTE FUNCTION "public"."update_material_stock_on_job_usage"();



CREATE OR REPLACE TRIGGER "trigger_update_security_settings_updated_at" BEFORE UPDATE ON "public"."security_settings" FOR EACH ROW EXECUTE FUNCTION "public"."update_security_settings_updated_at"();



CREATE OR REPLACE TRIGGER "trigger_update_tool_status_on_assignment" AFTER INSERT OR UPDATE ON "public"."tool_assignments" FOR EACH ROW EXECUTE FUNCTION "public"."update_tool_status_on_assignment"();
...
CREATE OR REPLACE TRIGGER "update_job_payment_after_delete" AFTER DELETE ON "public"."payments" FOR EACH ROW EXECUTE FUNCTION "public"."update_job_payment_status_on_delete"();



CREATE OR REPLACE TRIGGER "update_job_payment_after_insert" AFTER INSERT ON "public"."payments" FOR EACH ROW EXECUTE FUNCTION "public"."update_job_payment_status"();



CREATE OR REPLACE TRIGGER "update_job_payment_after_update" AFTER UPDATE ON "public"."payments" FOR EACH ROW EXECUTE FUNCTION "public"."update_job_payment_status"();



CREATE OR REPLACE TRIGGER "update_job_photos_updated_at" BEFORE UPDATE ON "public"."job_photos" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "update_square_connections_updated_at" BEFORE UPDATE ON "public"."square_connections" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."alerts"
    ADD CONSTRAINT "alerts_email_id_fkey" FOREIGN KEY ("email_id") REFERENCES "public"."emails_raw"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."billing_events"
    ADD CONSTRAINT "billing_events_email_id_fkey" FOREIGN KEY ("email_id") REFERENCES "public"."emails_raw"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."email_insights"
    ADD CONSTRAINT "email_insights_email_id_fkey" FOREIGN KEY ("email_id") REFERENCES "public"."emails_raw"("id") ON DELETE CASCADE;
...
CREATE POLICY "Account members can view estimates" ON "public"."estimates" FOR SELECT USING (
CASE
...
CREATE POLICY "Account members can view job notes" ON "public"."job_notes" FOR SELECT USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."is_active" = true)))));



CREATE POLICY "Account members can view leads" ON "public"."leads" FOR SELECT USING (
CASE
    WHEN ("account_id" IS NOT NULL) THEN ("account_id" IN ( SELECT "account_memberships"."account_id"
       FROM "public"."account_memberships"
      WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."is_active" = true))))
...
CREATE POLICY "Account members can view properties" ON "public"."properties" FOR SELECT USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."is_active" = true)))));
...
CREATE POLICY "Admins can manage all job notes" ON "public"."job_notes" USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
...
CREATE POLICY "Admins can manage clients" ON "public"."clients" USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
...
CREATE POLICY "Admins can manage estimates" ON "public"."estimates" USING (
CASE
    WHEN ("account_id" IS NOT NULL) THEN ("account_id" IN ( SELECT "account_memberships"."account_id"
       FROM "public"."account_memberships"
      WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true))))
...
CREATE POLICY "Admins can manage jobs" ON "public"."jobs" USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true))))) WITH CHECK (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true)))));
...
CREATE POLICY "Admins can manage leads" ON "public"."leads" USING (
CASE
    WHEN ("account_id" IS NOT NULL) THEN ("account_id" IN ( SELECT "account_memberships"."account_id"
       FROM "public"."account_memberships"
      WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true))))
...
CREATE POLICY "Admins can manage properties" ON "public"."properties" USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true)))));



CREATE POLICY "Admins can manage visits in their account" ON "public"."visits" USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."is_active" = true) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"]))))));
...
CREATE POLICY "Admins can view jobs" ON "public"."jobs" FOR SELECT USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true)))));



CREATE POLICY "Admins can view notes" ON "public"."job_notes" FOR SELECT USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = ANY (ARRAY['OWNER'::"text", 'ADMIN'::"text"])) AND ("account_memberships"."is_active" = true)))));



CREATE POLICY "Allow all operations on alerts" ON "public"."alerts" USING (true);



CREATE POLICY "Allow all operations on billing_events" ON "public"."billing_events" USING (true);



CREATE POLICY "Allow all operations on clients" ON "public"."clients" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all operations on email_insights" ON "public"."email_insights" USING (true);



CREATE POLICY "Allow all operations on email_lead_details" ON "public"."email_lead_details" USING (true);



CREATE POLICY "Allow all operations on emails_raw" ON "public"."emails_raw" USING (true);



CREATE POLICY "Allow all operations on gmail_connections" ON "public"."gmail_connections" USING (true);
...
CREATE POLICY "Allow all operations on invoice_payments" ON "public"."invoice_payments" USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all operations on job_line_items" ON "public"."job_line_items" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all operations on job_photos" ON "public"."job_photos" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all operations on jobs" ON "public"."jobs" USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all operations on properties" ON "public"."properties" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all operations on square_connections" ON "public"."square_connections" USING (true) WITH CHECK (true);
...
CREATE POLICY "Authenticated users can manage clients" ON "public"."clients" USING (("auth"."uid"() IS NOT NULL));



CREATE POLICY "Authenticated users can manage customers" ON "public"."customers" USING (("auth"."uid"() IS NOT NULL));
...
CREATE POLICY "Techs can insert notes for assigned jobs" ON "public"."job_notes" FOR INSERT WITH CHECK ((("technician_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."jobs" "j"
  WHERE (("j"."id" = "job_notes"."job_id") AND ("j"."assigned_tech_id" = "auth"."uid"()) AND ("j"."account_id" = "job_notes"."account_id"))))));



CREATE POLICY "Techs can insert notes on assigned jobs" ON "public"."job_notes" FOR INSERT WITH CHECK ((("technician_id" = "auth"."uid"()) AND ("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = 'TECH'::"text") AND ("account_memberships"."is_active" = true)))) AND ("job_id" IN ( SELECT "jobs"."id"
   FROM "public"."jobs"
  WHERE ("jobs"."assigned_tech_id" = "auth"."uid"())))));



CREATE POLICY "Techs can view assigned jobs" ON "public"."jobs" FOR SELECT USING ((("assigned_tech_id" = "auth"."uid"()) AND ("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."role" = 'TECH'::"text") AND ("account_memberships"."is_active" = true))))));



CREATE POLICY "Techs can view notes for assigned jobs" ON "public"."job_notes" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."jobs" "j"
  WHERE (("j"."id" = "job_notes"."job_id") AND ("j"."assigned_tech_id" = "auth"."uid"())))));
...
CREATE POLICY "Users can view visits in their account" ON "public"."visits" FOR SELECT USING (("account_id" IN ( SELECT "account_memberships"."account_id"
   FROM "public"."account_memberships"
  WHERE (("account_memberships"."user_id" = "auth"."uid"()) AND ("account_memberships"."is_active" = true)))));
...
GRANT ALL ON FUNCTION "public"."calculate_next_maintenance_date"("last_date" "date", "interval_days" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_next_maintenance_date"("last_date" "date", "interval_days" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_next_maintenance_date"("last_date" "date", "interval_days" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."calculate_time_entry_totals"() TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_time_entry_totals"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_time_entry_totals"() TO "service_role";



GRANT ALL ON FUNCTION "public"."execute_job_workflow"("job_uuid" "uuid", "workflow_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."execute_job_workflow"("job_uuid" "uuid", "workflow_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."execute_job_workflow"("job_uuid" "uuid", "workflow_uuid" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_current_technician_rate"("tech_name" "text", "check_date" "date") TO "anon";
GRANT ALL ON FUNCTION "public"."get_current_technician_rate"("tech_name" "text", "check_date" "date") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_current_technician_rate"("tech_name" "text", "check_date" "date") TO "service_role";



GRANT ALL ON FUNCTION "public"."get_tool_recognition_stats"("days_back" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_tool_recognition_stats"("days_back" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_tool_recognition_stats"("days_back" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."process_tool_recognition_matches"() TO "anon";
GRANT ALL ON FUNCTION "public"."process_tool_recognition_matches"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_tool_recognition_matches"() TO "service_role";



GRANT ALL ON FUNCTION "public"."record_material_transaction"() TO "anon";
GRANT ALL ON FUNCTION "public"."record_material_transaction"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."record_material_transaction"() TO "service_role";



GRANT ALL ON FUNCTION "public"."schedule_next_maintenance"() TO "anon";
GRANT ALL ON FUNCTION "public"."schedule_next_maintenance"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."schedule_next_maintenance"() TO "service_role";



GRANT ALL ON FUNCTION "public"."set_estimate_number"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_estimate_number"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_estimate_number"() TO "service_role";
...
REVOKE ALL ON FUNCTION "public"."tech_update_job_status"("p_job_id" "uuid", "p_new_status" "text") FROM PUBLIC;
GRANT ALL ON FUNCTION "public"."tech_update_job_status"("p_job_id" "uuid", "p_new_status" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."tech_update_job_status"("p_job_id" "uuid", "p_new_status" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."tech_update_job_status"("p_job_id" "uuid", "p_new_status" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."trigger_job_workflows"() TO "anon";
GRANT ALL ON FUNCTION "public"."trigger_job_workflows"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."trigger_job_workflows"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_ai_estimate_settings_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_ai_estimate_settings_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_ai_estimate_settings_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_business_settings_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_business_settings_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_business_settings_updated_at"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_employee_profile_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_employee_profile_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_employee_profile_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_estimates_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_estimates_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_estimates_updated_at"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_job_payment_status"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_job_payment_status"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_job_payment_status"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_job_payment_status_on_delete"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_job_payment_status_on_delete"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_job_payment_status_on_delete"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_job_templates_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_job_templates_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_job_templates_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_job_workflows_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_job_workflows_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_job_workflows_updated_at"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_material_stock_on_job_usage"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_material_stock_on_job_usage"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_material_stock_on_job_usage"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_security_settings_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_security_settings_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_security_settings_updated_at"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_tool_status_on_assignment"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_tool_status_on_assignment"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_tool_status_on_assignment"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."user_is_account_admin"("account_uuid" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."user_is_account_admin"("account_uuid" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."user_is_account_admin"("account_uuid" "uuid") TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_estimate_settings" TO "anon";
GRANT ALL ON TABLE "public"."ai_estimate_settings" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_estimate_settings" TO "service_role";
...
GRANT ALL ON TABLE "public"."automation_history" TO "anon";
GRANT ALL ON TABLE "public"."automation_history" TO "authenticated";
GRANT ALL ON TABLE "public"."automation_history" TO "service_role";
...
GRANT ALL ON TABLE "public"."channel_accounts" TO "anon";
GRANT ALL ON TABLE "public"."channel_accounts" TO "authenticated";
GRANT ALL ON TABLE "public"."channel_accounts" TO "service_role";
...
GRANT ALL ON TABLE "public"."email_insights" TO "anon";
GRANT ALL ON TABLE "public"."email_insights" TO "authenticated";
GRANT ALL ON TABLE "public"."email_insights" TO "service_role";



GRANT ALL ON TABLE "public"."email_lead_details" TO "anon";
GRANT ALL ON TABLE "public"."email_lead_details" TO "authenticated";
GRANT ALL ON TABLE "public"."email_lead_details" TO "service_role";
...
GRANT ALL ON TABLE "public"."emails_raw" TO "anon";
GRANT ALL ON TABLE "public"."emails_raw" TO "authenticated";
GRANT ALL ON TABLE "public"."emails_raw" TO "service_role";
...
GRANT ALL ON TABLE "public"."job_time_summary" TO "anon";
GRANT ALL ON TABLE "public"."job_time_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."job_time_summary" TO "service_role";



GRANT ALL ON TABLE "public"."job_tools" TO "anon";
GRANT ALL ON TABLE "public"."job_tools" TO "authenticated";
GRANT ALL ON TABLE "public"."job_tools" TO "service_role";



GRANT ALL ON TABLE "public"."job_workflow_executions" TO "anon";
GRANT ALL ON TABLE "public"."job_workflow_executions" TO "authenticated";
GRANT ALL ON TABLE "public"."job_workflow_executions" TO "service_role";



GRANT ALL ON TABLE "public"."job_workflows" TO "anon";
GRANT ALL ON TABLE "public"."job_workflows" TO "authenticated";
GRANT ALL ON TABLE "public"."job_workflows" TO "service_role";
...
GRANT ALL ON TABLE "public"."material_transactions" TO "anon";
GRANT ALL ON TABLE "public"."material_transactions" TO "authenticated";
GRANT ALL ON TABLE "public"."material_transactions" TO "service_role";
...
GRANT ALL ON TABLE "public"."square_connections" TO "anon";
GRANT ALL ON TABLE "public"."square_connections" TO "authenticated";
...
GRANT ALL ON TABLE "public"."technician_productivity" TO "anon";
GRANT ALL ON TABLE "public"."technician_productivity" TO "authenticated";
GRANT ALL ON TABLE "public"."technician_productivity" TO "service_role";



GRANT ALL ON TABLE "public"."technician_rates" TO "anon";
GRANT ALL ON TABLE "public"."technician_rates" TO "authenticated";
GRANT ALL ON TABLE "public"."technician_rates" TO "service_role";



GRANT ALL ON TABLE "public"."time_approvals" TO "anon";
GRANT ALL ON TABLE "public"."time_approvals" TO "authenticated";
GRANT ALL ON TABLE "public"."time_approvals" TO "service_role";



GRANT ALL ON TABLE "public"."time_breaks" TO "anon";
GRANT ALL ON TABLE "public"."time_breaks" TO "authenticated";
GRANT ALL ON TABLE "public"."time_breaks" TO "service_role";



GRANT ALL ON TABLE "public"."time_tracking_summary" TO "anon";
GRANT ALL ON TABLE "public"."time_tracking_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."time_tracking_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."tool_availability" TO "anon";
GRANT ALL ON TABLE "public"."tool_availability" TO "authenticated";
GRANT ALL ON TABLE "public"."tool_availability" TO "service_role";
...
GRANT ALL ON TABLE "public"."tool_inventory_counts" TO "anon";
GRANT ALL ON TABLE "public"."tool_inventory_counts" TO "authenticated";
GRANT ALL ON TABLE "public"."tool_inventory_counts" TO "service_role";
...
GRANT ALL ON TABLE "public"."tool_recognition_matches" TO "anon";
GRANT ALL ON TABLE "public"."tool_recognition_matches" TO "authenticated";
GRANT ALL ON TABLE "public"."tool_recognition_matches" TO "service_role";



GRANT ALL ON TABLE "public"."tool_recognition_results" TO "anon";
GRANT ALL ON TABLE "public"."tool_recognition_results" TO "authenticated";
GRANT ALL ON TABLE "public"."tool_recognition_results" TO "service_role";



GRANT ALL ON TABLE "public"."tool_recognition_summary" TO "anon";
GRANT ALL ON TABLE "public"."tool_recognition_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."tool_recognition_summary" TO "service_role";

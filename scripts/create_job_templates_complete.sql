-- Complete job templates table creation and setup
-- This handles the case where the table may not exist or is incomplete

-- Drop table if it exists but is malformed
DROP TABLE IF EXISTS job_templates;

-- Create job templates table for reusable job configurations
